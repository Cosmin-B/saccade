...
class DesktopPipeline final {
  ...
  private:
    ...
    static SaccadeResult execute_agent_background_press(void*, uint64_t, const SaccadeAgentGeneration&, uint64_t, const SaccadeAgentTarget&,
                                                        bool, agent::BackgroundActionExecution*) noexcept;
