...
using ExecuteBackgroundPressFn = SaccadeResult (*)(void*, uint64_t request_id, const SaccadeAgentGeneration&, uint64_t session_epoch,
                                                   const SaccadeAgentTarget&, bool dry_run, BackgroundActionExecution*) noexcept;
...
class Service final {
  ...
  private:
    ...
    SaccadeResult observe(const SaccadeAgentObserveRequest&, SaccadeAgentCapabilityBits, uint64_t, SaccadeMutableSpanU8, size_t*) noexcept;
