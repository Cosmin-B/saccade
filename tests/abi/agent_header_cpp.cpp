...
static_assert(sizeof(SaccadeAgentGeneration) == 80);
...
static_assert(sizeof(SaccadeAgentObserveCompletion) == 168);
static_assert(sizeof(SaccadeAgentQueryRequest) == 112);
static_assert(sizeof(SaccadeAgentQueryCompletion) == 168);
...
static_assert(sizeof(SaccadeAgentActionCompletion) == 192);
